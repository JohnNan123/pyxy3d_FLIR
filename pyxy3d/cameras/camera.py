...
class Camera:
    ...
    def __init__(self, port, verified_resolutions = None, connect_API = None):
        ...
        test_capture = EasyPySpin.VideoCapture(port) #JN
        test_capture.set(cv2.CAP_PROP_TRIGGER, False)
        ...
        if good_read:
            ...
            # self.capture.set( # comment out by JN
            ...
            # self.set_exposure() # comment out by JN 
    ...
    def connect(self):
        self.capture = EasyPySpin.VideoCapture(self.port, self.connect_API)
